...
export const skills = [
  ...
  { name: "SQL", level: 90, category: "languages", icon: sql },

  { name: "React.js", level: 85, category: "frameworks", icon: reactjs },
  { name: "Tailwind CSS", level: 85, category: "frameworks", icon: tailwind },
  { name: "Node.js", level: 85, category: "frameworks", icon: nodejs },
  { name: "ASP.NET", level: 85, category: "frameworks", icon: aspnet },

  { name: "Eclipse", level: 90, category: "tools", icon: eclipse },
  { name: "VS Code", level: 90, category: "tools", icon: vscode },
  { name: "Code::Blocks", level: 90, category: "tools", icon: codeblocks },
  { name: "Git/GitHub", level: 85, category: "tools", icon: github },
  { name: "UiPath", level: 80, category: "tools", icon: uipath },
  { name: "Google Colab", level: 90, category: "tools", icon: colab },
];
